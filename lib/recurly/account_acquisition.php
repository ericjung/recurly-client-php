...
class Recurly_AccountAcquisition extends Recurly_Resource
{
  ...
  public static function init() {
    Recurly_AccountAcquisition::$_writeableAttributes = array(
  ...
  protected static function uriForAccountAcquisition($accountCode) {
    return Recurly_Client::PATH_ACCOUNTS . '/' . rawurlencode($accountCode) . Recurly_Client::PATH_ACQUISITION;
  }
  ...
  protected function getWriteableAttributes() {
    return Recurly_AccountAcquisition::$_writeableAttributes;
  }
}

Recurly_AccountAcquisition::init();
